    ...
    return (
        <>
            <div className="w-full flex flex-col gap-5 p-5">
                <h1>Propostas da tarefa: <strong> { getData != 'failed' &&  getData.title } </strong> </h1>
                            ...
                            { (getData != 'failed' && getData.propostas.length > 0) ? (
                                getData.propostas.map((item: any, index: any)=> (
                                    <tr className="px-3 border-b border-slate-300 dark:border-gray-700" key={index}>
                                        ...
                                        <td >
                                            <AcceptProposta type="tarefa" itemId={params.id} data={item} />
                                        </td>
                                    </tr>
                                ))
                            ) : 'Esta tarefa ainda não tem propostas.' }
                        </tbody>
                    </table>
